...
public class CoreProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":core:ai-agent"
     */
    public Core_AiAgentProjectDependency getAiAgent() { return new Core_AiAgentProjectDependency(getFactory(), create(":core:ai-agent")); }
