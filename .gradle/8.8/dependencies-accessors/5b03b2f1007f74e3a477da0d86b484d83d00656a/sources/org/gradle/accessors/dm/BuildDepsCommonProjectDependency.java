...
@NonNullApi
public class BuildDepsCommonProjectDependency extends DelegatingProjectDependency {

    @Inject
    public BuildDepsCommonProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
